...
background1 = image_import.get_image("pictures for survivor game/backgrounds/menu backgrounds/save background.png",(1280,720))
background2 = image_import.get_image("pictures for survivor game/backgrounds/menu backgrounds/login screen background.png",(1280,720))
